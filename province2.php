    ...
    <div class="container">
        <div class="navbar">
            ...
            <h5>Add Muncipality</h5>
                <a href="add1.php"><img src="logo1.png" class="hero"></a>
            </div>
            <div class="table-container">
                <h1 class="heading">Province 2</h1>
                <table class="table">
                    <thead>
         ...
         ?>
           ...
           <td data-label="Option"><a href=<?php echo "delete2.php?id={$row['id']}&delete=delete"?> class="btn"><input type="submit" name="Delete" class="btn" value="Delete" 
