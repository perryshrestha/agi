  ...
  <div class="mainbody">
   ...
   <div class="table-container">
     ...
     <div class="add">
      ...
      <a href="detail.html" target = "_blank"><img  src="logo1.png" class="right" /></a>
        </div>
     <table class="table">
       <thead>
         <tr>
       ...
       <?php
         ...
         ?>
           ...
           <td data-label="Farmer Rate" name= "Farmer product"><?php echo $row["farmingCrops"]; ?></td>
           <td data-label="Option"><a href=<?php echo "edit.php?id={$row['id']}"?> class="btn-danger">Edit</a></td>
           <td data-label="Option"><a href=<?php echo "edit.php?id={$row['id']}&delete=delete"?> class="btn">Delete</a></td>
